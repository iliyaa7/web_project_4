export const openEditProfileFormBtn = document.querySelector(".profile__info-button");
export const openAddCardFromBtn = document.querySelector(".profile__plus-button");
